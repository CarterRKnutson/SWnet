...
# if __name__ == '__main__':
    ...
    """Load GDSC drug similarity data."""
    ...
    # model_ft.load_state_dict(torch.load("../log/pth/0.9384_SWnet_GDSC_self-attention_train_r3_s0.pth"))
...
if __name__ == '__main__':
    ...
    print(gParameters)
    handler = logging.FileHandler( os.path.join(CANDLE_DATA_DIR, gParameters['model_name'], 'Output', 'gdsc_eval_log.txt'), mode='w' )
