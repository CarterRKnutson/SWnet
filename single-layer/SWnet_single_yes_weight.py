...
class Model(nn.Module):
    def __init__(self,dim,layer_gnn):
        super(Model, self).__init__()
        self.fuse_weight = torch.nn.Parameter(torch.FloatTensor(1, 1478), requires_grad=True)
